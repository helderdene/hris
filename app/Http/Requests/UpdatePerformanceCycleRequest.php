...
class UpdatePerformanceCycleRequest extends FormRequest
{
    ...
    {
        $performanceCycle = $this->route('performanceCycle');
        $cycleId = $performanceCycle instanceof PerformanceCycle ? $performanceCycle->id : $performanceCycle;
        ...
        return [
            ...
            'code' => [
                ...
                'string',
                'max:50',
                Rule::unique(PerformanceCycle::class, 'code')->ignore($cycleId),
            ],
            'cycle_type' => ['sometimes', 'required', new Enum(PerformanceCycleType::class)],
