...
class UpdateLeaveTypeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => ['sometimes', 'required', 'string', 'max:50', Rule::unique(LeaveType::class, 'code')->ignore($leaveTypeId)],
            'description' => ['nullable', 'string'],
            'leave_category' => ['sometimes', 'required', new Enum(LeaveCategory::class)],

            // Accrual Configuration
            'accrual_method' => ['sometimes', 'required', new Enum(AccrualMethod::class)],
            'default_days_per_year' => ['sometimes', 'required', 'numeric', 'min:0', 'max:365'],
