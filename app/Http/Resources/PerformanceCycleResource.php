...
/**
 * @property-read \App\Models\PerformanceCycle $resource
 */
class PerformanceCycleResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'instances_per_year' => $this->resource->getInstancesPerYear(),
            'instances_count' => $this->when(
                $this->resource->relationLoaded('performanceCycleInstances'),
                fn () => $this->resource->performanceCycleInstances->count()
            ),
