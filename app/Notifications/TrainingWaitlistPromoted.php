...
/**
 * Notification sent when an employee is promoted from waitlist to enrolled.
 */
class TrainingWaitlistPromoted extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('You\'re In! - '.$session->display_title)
            ->greeting('Great news, '.$notifiable->name.'!')
            ->line('A spot has opened up and you have been enrolled in the following training session:')
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'message' => "You've been promoted from the waitlist and are now enrolled in {$session->display_title}!",
        ];
    }
