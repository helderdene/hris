...
/**
 * Notification sent to employees when their overtime request is rejected.
 */
class OvertimeRequestRejected extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Overtime Request Rejected - '.$this->request->reference_number)
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'reason' => $this->reason,
            'message' => "Your overtime request {$this->request->reference_number} for {$this->request->overtime_date->format('M d, Y')} has been rejected.",
        ];
    }
