...
/**
 * Status of a leave application request.
 *
...
enum LeaveApplicationStatus: string
{
    ...
    /**
     * Check if this status reserves leave balance.
     */
    ...
    /**
     * Check if leave can be edited in this status.
     */
    ...
    /**
     * Check if leave can be cancelled in this status.
     */
