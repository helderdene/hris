...
/**
 * Status of a loan application request.
 *
...
enum LoanApplicationStatus: string
{
    ...
    /**
     * Check if the loan application can be edited in this status.
     */
    ...
    /**
     * Check if the loan application can be cancelled in this status.
     */
