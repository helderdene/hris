...
/**
 * LeaveApplicationApproval model for tracking approval chain.
 *
 * Each level in the approval chain has its own record with approver snapshot
 * for audit trail purposes.
 */
class LeaveApplicationApproval extends TenantModel
{
    /** @use HasFactory<\Database\Factories\LeaveApplicationApprovalFactory> */
    use HasFactory;
    ...
    /**
     * Get the leave application this approval belongs to.
     */
    ...
    /**
     * Mark this approval as skipped (e.g., approver no longer available).
     */
