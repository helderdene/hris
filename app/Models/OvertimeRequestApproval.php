...
/**
 * OvertimeRequestApproval model for tracking approval chain.
 *
 * Each level in the approval chain has its own record with approver snapshot
 * for audit trail purposes.
 */
class OvertimeRequestApproval extends TenantModel
{
    /** @use HasFactory<\Database\Factories\OvertimeRequestApprovalFactory> */
    use HasFactory;
    ...
    /**
     * Get the overtime request this approval belongs to.
     */
    ...
    {
        return $query->where('decision', OvertimeApprovalDecision::Pending);
    }
    ...
    protected function isPending(): Attribute
    {
        return Attribute::make(
            get: fn () => $this->decision === OvertimeApprovalDecision::Pending
        );
    }
    ...
    {
        $this->decision = OvertimeApprovalDecision::Approved;
    ...
    {
        $this->decision = OvertimeApprovalDecision::Rejected;
        $this->remarks = $reason;
        $this->decided_at = now();
        $this->save();
    }
    ...
    {
        $this->decision = OvertimeApprovalDecision::Skipped;
    ...
    /**
     * Scope to filter approvals approaching deadline.
     */
