...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\JobRequisitionApproval>
 */
class JobRequisitionApprovalFactory extends Factory
{
    /**
     * The name of the factory's corresponding model.
     */
    protected $model = JobRequisitionApproval::class;
