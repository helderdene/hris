...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Creates the leave_application_approvals table for tracking approval chain.
    ...
    public function up(): void
    {
        Schema::create('leave_application_approvals', function (Blueprint $table) {
            ...
            // Relationship to leave application
            ...
            // Unique constraint: one approval per level per application
            $table->unique(['leave_application_id', 'approval_level'], 'leave_app_approvals_unique');
