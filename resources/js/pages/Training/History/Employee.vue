...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Training History', href: `/training/history/employee/${props.employee.id}` },
];
...
function applyFilters() {
    router.get(
        `/training/history/employee/${props.employee.id}`,
        {
...
<template>
    <Head :title="`Training History - ${employee.full_name} - ${tenantName}`" />
    ...
    <TenantLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-col gap-6">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                            {{ employee.full_name }} ({{ employee.employee_number }}) - {{ totalCount }} training records
                        </p>
                    </div>
                </div>
            ...
            <div v-else class="rounded-xl border border-slate-200 bg-white px-6 py-12 text-center dark:border-slate-700 dark:bg-slate-900">
                ...
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                    {{ employee.full_name }} has no training records yet.
                </p>
            </div>
        </div>
    </TenantLayout>
