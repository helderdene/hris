            ...
            <template v-else>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="min-w-[160px] text-center text-sm font-medium text-slate-700 dark:text-slate-300">
                            {{ currentMonthLabel }}
                        </span>
                        <Button variant="outline" size="icon" @click="navigateMonth(1)">
                ...
                <!-- Summary Cards -->
                <DtrSummaryCard v-if="summary" :summary="summary" />
