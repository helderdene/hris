...
async function handleSubmit() {
    ...
    const url = isEditing.value
        ? `/api/organization/performance-cycles/${props.cycle!.id}`
        : '/api/organization/performance-cycles';
    ...
    try {
        ...
        errors.value = {
            general: 'An error occurred while saving the performance cycle',
        };
    } finally {
        ...
        <DialogContent class="max-h-[90vh] overflow-y-auto sm:max-w-lg">
            <DialogHeader>
                ...
                <DialogDescription>
                    {{
                        isEditing
                            ? 'Update the performance cycle details below.'
                            : 'Fill in the details to create a new performance cycle.'
                    }}
                </DialogDescription>
            </DialogHeader>
            ...
            <form @submit.prevent="handleSubmit" class="space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <Textarea
                        ...
                        placeholder="Optional description of this performance cycle"
                        rows="2"
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="grid gap-1.5 leading-none">
                        ...
                        <p class="text-sm text-muted-foreground">
                            The default cycle is used when generating instances
                            automatically.
                        </p>
                    </div>
                </div>
