...
<body style="margin: 0; padding: 0; width: 100%; -webkit-font-smoothing: antialiased; word-break: break-word; background-color: #f4f5f7;">
    ...
    <div style="display: none; max-height: 0; overflow: hidden;">
        Welcome to {{ $tenantName }}! Set up your account to access your pre-boarding checklist.
                                ...
                                <tr>
                                    <td style="padding: 44px 40px 40px;">
                                            ...
                                            <tr>
                                                <td style="background-color: #f9fafb; border-radius: 8px; border: 1px solid #f0f0f3; padding: 20px 24px;">
                                                    ...
                                                    <p style="margin: 0; font-size: 15px; font-weight: 600; color: #111827; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
                                                        Complete your pre-boarding checklist
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <p style="margin: 0 0 28px; font-size: 15px; color: #374151; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6;">
                                            Congratulations on joining our team! Click the button below to set your password and access your employee portal, where you can complete your pre-boarding requirements.
                                        </p>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 28px;">
                                            <tr>
                                                <td align="center">
                                                    <!--[if mso]>
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="{{ $setupUrl }}" style="height: 48px; width: 240px; v-text-anchor: middle;" arcsize="17%" fillcolor="{{ $primaryColor }}">
                                                        <w:anchorlock/>
                                                        <center style="color: #ffffff; font-family: 'Segoe UI', sans-serif; font-size: 15px; font-weight: 600;">Set Up Your Account</center>
                                                    </v:roundrect>
                                                    <![endif]-->
                                                    <!--[if !mso]><!-->
                                                    <a href="{{ $setupUrl }}" target="_blank" style="display: inline-block; padding: 14px 36px; background-color: {{ $primaryColor }}; color: #ffffff; font-size: 15px; font-weight: 600; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 8px; line-height: 1; text-align: center;">
                                                        Set Up Your Account
                                                    </a>
                                                    <!--<![endif]-->
                                                </td>
                                            ...
                                            <tr>
                                                <td style="border-top: 1px solid #f0f0f3; padding-top: 20px;">
                                                    <p style="margin: 0; font-size: 13px; color: #9ca3af; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.5;">
                                                        This link expires in <strong style="color: #6b7280;">30 days</strong>. If you have any questions, please contact HR.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
