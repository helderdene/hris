        ...
        <div class="summary-box">
            ...
            <div class="summary-grid">
                <div class="summary-item">
                    ...
                    <div class="summary-value">{{ number_format($totals['sss_employee'], 2) }}</div>
                </div>
                <div class="summary-item">
                    <div class="summary-label">Employer Share</div>
                    <div class="summary-value">{{ number_format($totals['sss_employer'], 2) }}</div>
                </div>
                <div class="summary-item">
                    <div class="summary-label">EC</div>
                    <div class="summary-value">{{ number_format($totals['sss_ec'], 2) }}</div>
                </div>
                <div class="summary-item">
