    ...
    <div class="report">
        <div class="header">
            ...
            <div class="report-title">
                {{ $report['title'] }}
                <span class="annual-badge">Annual Report</span>
            </div>
        ...
        <div class="summary-box">
            <div class="summary-title">ANNUAL WITHHOLDING TAX SUMMARY</div>
        ...
        <div class="footer">
            <p>BIR Form 1604-CF - Annual Information Return of Income Taxes Withheld on Compensation</p>
